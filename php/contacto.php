...
<!--------------------------------------------------------------- FORM ------------------------------------------------------------->
                            ...
                            <div class="box-footer clearfix" style="background-color:beige;">
                                ...
                                <div>
                                    <fieldset>
                                        <dl><dt><label>Area que desea contactar:</label></dt><dd>
                                        <span class="select"><select><option value="">-No Seleccionado-</option>
                                        ...
                                        </select></span></dd></dl><dl><dt><label>Nombre:</label></dt><dd>
                                        <input type="text" placeholder="Ingresa tu nombre" required=""></dd></dl><dl><dt>
                                        <label>Apellido Paterno:</label></dt><dd>
                                        <input type="text" placeholder="Ingresa tu Apellido Paterno" required=""></dd></dl><dl><dt>
                                        <label>Apellido Materno:</label></dt><dd>
                                        ...
                                        <option value="Baja California Sur">Baja California Sur</option><option value="Campeche">Campeche</option>
                                        <option value="Coahuila">Coahuila</option>
                                        <option value="Colima">Colima</option><option value="Chiapas">Chiapas</option>
                                        ...
                                        <option value="Querétaro">Querétaro</option><option value="Quintana Roo">Quintana Roo</option>
                                        <option value="San Luis Potosí">San Luis Potosí</option><option value="Sinaloa">Sinaloa</option>
